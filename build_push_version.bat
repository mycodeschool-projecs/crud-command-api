...
docker buildx build --platform linux/amd64,linux/arm64 -f Dockerfile -t mycodeschool/kube-ms1:%SERVICE_VERSION% --push .
@REM docker buildx build --platform linux/amd64 -f Dockerfile -t ion21/kube-ms1:%SERVICE_VERSION% --push .
